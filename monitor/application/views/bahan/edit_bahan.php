                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo site_url('bahan/edit')?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nama Bahan</label>
                                                <input type="text" class="form-control" name="nama" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $bahan->nama_bahan ?>">
                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Satuan</label>
                                                <input type="text" class="form-control" name="satuan" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $bahan->satuan ?>">
